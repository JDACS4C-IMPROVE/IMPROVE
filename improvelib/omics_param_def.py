...
omics_params = [
    {"name": "copy_number_fname",
     "default":"cancer_copy_number.tsv",
     "type": str,
     "help": "Copy number filename",
    },
    {"name": "discretized_copy_number_fname",
     "default":"cancer_discretized_copy_number.tsv",
     "type": str,
     "help": "Discretized copy number filename",
    },
    {"name": "dna_methylation_fname",
     "default": "cancer_DNA_methylation.tsv",
     "type": str,
     "help": "DNA methylation filename",
    },
    {"name": "gene_expression_fname",
     "default": "cancer_gene_expression.tsv",
     "type": str,
     "help": "Gene expression filename",
    },
    {"name": "miRNA_expression_fname",
     "default": "cancer_miRNA_expression.tsv",
     "type": str,
     "help": "miRNA expression filename",
    },
    {"name": "mutation_count_fname", 
     "default": "cancer_mutation_count.tsv",
     "type": str,
     "help": "Mutation count filename",
    },
    {"name": "mutation_long_format_fname", 
     "default": "cancer_mutation_long_format.tsv",
     "type": str,
     "help": "Mutation count long format filename",
    },
    {"name": "mutation_fname", 
     "default": "cancer_mutation.parquet",
     "type": str,
     "help": "Mutation filename",
    },
    {"name": "rppa_fname", 
     "default": "cancer_RPPA.tsv",
     "type": str,
     "help": "Reverse Phase Protein Array (RPPA) filename",
    },
]
