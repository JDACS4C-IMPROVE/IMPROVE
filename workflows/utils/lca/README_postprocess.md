...
* `--model_name`: Name of the model, if you would like it saved in the data (default: `None`).
* `--dataset`: Name of the dataset, if you would like it saved in the data (default: `None`).
