...
#Model scripts
params['train_python_script'] = os.path.join(params['model_dir'],f"{params['model_name']}_train_improve.py")
params['infer_python_script'] = os.path.join(params['model_dir'],f"{params['model_name']}_infer_improve.py")
